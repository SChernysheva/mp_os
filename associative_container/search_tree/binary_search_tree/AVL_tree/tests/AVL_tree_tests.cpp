...
#include <iostream>
//todo rool 5 avl, iterator, const-move, assign?
    ...
    std::vector<typename AVL_tree<tkey, tvalue>::iterator_data> &expected_result)
{
    ...
    {
        //std::cout << "real depth: " << std::to_string((*it)->depth) << " expected depth: " << std::to_string(item.depth) << " keys: " << std::to_string((*it)->get_key()) << std::to_string(item.get_key()) <<std::endl;
...
TEST(AVLTreePositiveTests, test1)
{
    ...
    search_tree<int, std::string> *avl = new AVL_tree<int, std::string>(key_comparer());
    const std::string str = "a";
    const std::string str2 = "b";
    const std::string str3 = "c";
    const std::string str4 = "d";
    const std::string str5 = "e";
    const std::string str6 = "l";
    avl->insert(5, str);
    avl->insert(2, str2);
    avl->insert(15, str3);
    avl->insert(3, str4);
...
TEST(AVLTreePositiveTests, test2)
{
    ...
    search_tree<int, int> *avl = new AVL_tree<int, int>(key_comparer());
    const int i1 = 5;
    const int i2 = 12;
    const int i3 = 1;
    const int i4 = 67;
...
TEST(AVLTreePositiveTests, test3)
{
    ...
    search_tree<std::string, int> *avl = new AVL_tree<std::string, int>(key_comparer());
    const int i1 = 1;
    const int i2 = 2;
    const int i3 = 15;
    const int i4 = 3;
...
TEST(AVLTreePositiveTests, test4)
{
    ...
    const std::string str = "a";
    const std::string str2 = "c";
    const std::string str3 = "x";
    const std::string str4 = "j";
    const std::string str5 = "i";
    const std::string str6 = "b";
    ...
    std::vector<typename AVL_tree<int, std::string>::iterator_data> expected_result =
        {
            ...
            AVL_tree<int, std::string>::iterator_data(1, 4, "j", 2),
            //AVL_tree<int, std::string>::iterator_data(1, 5, "b", 1), //here52
            AVL_tree<int, std::string>::iterator_data(2, 5, "b", 1),
            AVL_tree<int, std::string>::iterator_data(0, 6, "a", 3),
            AVL_tree<int, std::string>::iterator_data(1, 8, "c", 2),
            AVL_tree<int, std::string>::iterator_data(2, 15, "x", 1)
